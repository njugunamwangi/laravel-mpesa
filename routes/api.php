...
// Tax Remittance
Route::post('/tax-remittance/result', [TaxRemittanceController::class, 'result'])->name('tax.remittance.result');
Route::post('/tax-remittance/timeout', [TaxRemittanceController::class, 'timeout'])->name('tax.remittance.timeout');
